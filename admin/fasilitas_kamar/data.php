                    ...
                    <td>
                        <?php foreach($rows as $row): ?>
                          ...
                          <p class="d-flex align-items-center my-1"><?= $row['id_fasilitas_kamar'] . ' and ' . $row['fasilitas_kamar']; ?>
                              <span class="ms-auto">
                                <a class='btn btn-danger btn-xs' href="/hotelindahhai/admin/fasilitas_kamar/delete.php?id_detail_kamar=<?= $row['id_detail_kamar'] ?>" onclick="
                ...
                while ($data = mysqli_fetch_array($query)) { ?>
                  ...
                  <li>
                    <p class="d-flex align-items-center my-1"><?= $data['fasilitas_kamar'] ?>
                      <span class="ms-auto">
                        <a class='btn btn-warning btn-xs' title='Edit Data' href="/hotelindahhai/admin/fasilitas_kamar/form.php?id=<?= $data['id_fasilitas_kamar'] ?>">
                        ...
                        <a class='btn btn-danger btn-xs' href="/hotelindahhai/admin/fasilitas_kamar/delete.php?id=<?= $data['id_fasilitas_kamar'] ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini ??')">
