            ...
            <div class="col-2">
                <div class="list-group">
                    ...
                    <?php if($_SESSION && $_SESSION['level'] == 'admin') : ?>
                        ...
                        <a href="../admin/data_user.php" class="list-group-item list-group-item-action active">Data User</a>
                    <?php endif; ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4>Data User</h4>
                            <a href="/hotelindahhai/admin/form_data_kamar.php" class="btn btn-primary">Tambah Data User</a>
                        </div>
                        <hr>
