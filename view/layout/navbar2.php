    ...
    <div class="d-flex justify-content-center">
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav" style="font-size: 16px;">
          ...
          <li class="nav-item">
            <a class=" btn btn-primary shadow me-3" style="color: white;"  href="index.php#fasilitashotel">WEBSITE</a>
          </li>
          <a href="/hotelindahhai/view/logout.php" class="nav-link me-3 text-white">Logout</a>
        </ul>
      </div>
    </div> 
  </div>
