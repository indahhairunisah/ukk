            ...
            <img src="/hotelindahhai/assets/view/image/hotel.PNG" alt="" width="100%" height="700" >
                <div class="col position-absolute start-50 top-50 translate-middle">
                    <div class="container">
                        ...
                        <a type="submit" class="text-white btn btn-primary text-shadow px-4 py-3" href="/hotelindahhai/view/tipe_kamar.php"> <b>LIHAT KAMAR</b></a>
                    </div>
                    <!-- <br><br><br><br><br> -->
                    <br>
                                    ...
                                    <form action="/hotelindahhai/view/reservasi.php" method="get">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="col">
                                                    <button type="submit" class="btn btn-info w-100" style="height: 100%;">Reservasi Sekarang</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                ...
                <div class="col-md py-2 text-center ">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Fasilitas : LED TV, AC, Free Wifi Dst</p>
                ...
                <div class="col-md py-2 text-center ">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Fasilitas : LED TV, AC, Free Wifi, Cofee Maker Dst</p>
                ...
                <div class="col-md py-2 text-center ">
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Fasilitas : LED TV, AC, Free Wifi, Cofee Maker, Sofa Dst</p>
